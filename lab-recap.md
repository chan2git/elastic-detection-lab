...
- [Alert Scenario 1: Unusual Web Scanning](https://github.com/chan2git/elastic-detection-lab/blob/main/lab-recap.md#alert-scenario-1-unusual-web-scanning)
    ...
    - [Conducting the Attack](https://github.com/chan2git/elastic-detection-lab/blob/main/lab-recap.md#conducting-the-attack)
...
- [Alert Scenario 2: Batch Files and Malicious Payloads](https://github.com/chan2git/elastic-detection-lab/blob/main/lab-recap.md#alert-scenario-2-batch-files-and-malicious-payloads)
...
- [Alert Scenario 3: Registry Edits, Data Staging, and Exfiltration](https://github.com/chan2git/elastic-detection-lab/blob/main/lab-recap.md#alert-scenario-3-registry-edits-data-staging-and-exfiltration)
